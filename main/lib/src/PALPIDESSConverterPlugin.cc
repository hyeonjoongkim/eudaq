...
public:
  ...
  virtual bool GetStandardSubEvent(StandardEvent &sev, const Event &ev) const {
    ...
    if (FRAME_LENGTH == 9) { // discard events with EoE-Frame as first frame, as
                             // they are empty or corrupted
  ...
  virtual bool GetLCIOSubEvent(lcio::LCEvent &lev,
    ...
    try {
      pALPIDEssDataCollection =
          static_cast<LCCollectionVec *>(lev.getCollection("zsdata_pALPIDEss"));
