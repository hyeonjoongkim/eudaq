...
int tcp_event_get(char *HOST, unsigned int *DATA, int *lenDATA, int *Nr_Mod,
                  int *ModuleID, unsigned int *Trig);
int tcp_event_snd(unsigned int *DATA, int lenDATA, int n, int i,
                  unsigned int evtHDR, unsigned int Trig);
