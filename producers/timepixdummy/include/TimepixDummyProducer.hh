...
protected:
  ...
  bool m_done;
  eudaq::Mutex m_done_mutex; // pthread_mutex_t m_done_mutex;
  unsigned m_run;
  eudaq::Mutex m_run_mutex; // pthread_mutex_t m_run_mutex;
  unsigned m_ev;
  eudaq::Mutex m_ev_mutex; // pthread_mutex_t m_ev_mutex;
