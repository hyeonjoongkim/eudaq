...
public:
  ...
  void send(const char *const p_uc_buffer, const int &r_i_numBytes,
            const uint64_t &ull_triggerID);
  void sendCorrupt(const char *const p_uc_buffer, const int &r_i_numBytes,
                   const uint64_t &ull_triggerID);
