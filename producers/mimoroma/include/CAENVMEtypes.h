...
typedef enum CVIOSources {
  ...
  cvInputSrc1 = 2, /* Input line 1
                      */
  cvCoincidence =
      3, /* Inputs coincidence						*/
  cvVMESignals =
      4, /* Signals from VME bus */
...
typedef enum CVRegisters {
  ...
  cvOutRegSet =
      0xA, /* Output register */
  cvInMuxRegSet =
      0xB, /* Input Multiplexer						*/
  cvOutMuxRegSet =
      0xC, /* Output Multiplexer */
  cvLedPolRegSet = 0xD, /* Led Polarity
                           */
  cvOutRegClear =
      0x10, /* Output register */
  cvInMuxRegClear =
      0x11, /* Input Multiplexer */
  cvOutMuxRegClear =
      0x12, /* Output Multiplexer */
...
typedef struct CVDisplay {
  ...
  long cvData;    /* VME Data
                     */
  CAEN_BYTE
      cvAM; /* Address modifier */
  CAEN_BYTE cvIRQ; /* IRQ levels
                      */
  CAEN_BOOL
      cvDS0; /* Data Strobe 0 signal */
  CAEN_BOOL
      cvDS1; /* Data Strobe 1 signal */
  ...
  CAEN_BOOL cvBERR; /* Bus Error signal
                       */
  CAEN_BOOL
      cvSYSRES; /* System Reset signal */
  CAEN_BOOL cvBR; /* Bus Request signal */
  CAEN_BOOL
      cvBG; /* Bus Grant signal */
} CVDisplay;
